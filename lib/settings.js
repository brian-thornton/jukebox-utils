...
const createRestrictionGroup = (restrictionGroup) => {
  dataAccess.write('content_restrictions', restrictionGroup.name, restrictionGroup);
};
...
const updateRestrictionGroup = (restrictionGroup) => {
  dataAccess.write('content_restrictions', restrictionGroup.name, restrictionGroup);
};
